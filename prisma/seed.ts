...
const artworks = [
  ...
  {
    title: "Le regard confisqué",
    titleEn: "The Confiscated Gaze",
    slug: "le-regard-confisque",
    category: "PAINTING" as const,
    medium: "Peinture",
    year: 2026,
    dimensions: "40 × 60 cm",
    imageUrl: "/artworks/le-regard-confisque.jpg",
    description:
      "Acrylique sur toile : portrait au bandeau rouge, mains qui lient le regard.",
    colSpan: 7,
    aspectRatio: "2319/3542",
    stretch: false,
    sortOrder: 8,
    published: true,
  },
  {
    title: "Esclave du désir",
    titleEn: "Slave of Desire",
    slug: "esclave-du-desir",
    category: "PAINTING" as const,
    medium: "Peinture",
    year: 2026,
    dimensions: "40 × 60 cm",
    imageUrl: "/artworks/esclave-du-desir.jpg",
    description:
      "Acrylique sur toile : figure au bandeau rouge, langue fourchue et motifs reptiliens.",
    colSpan: 5,
    aspectRatio: "1758/2733",
    stretch: false,
    sortOrder: 9,
    published: true,
  },
